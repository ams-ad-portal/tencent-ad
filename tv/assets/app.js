...
const TV_ITEMS = [
  ...
  },
  {
    ...
    img: "images/yucixiaowuzuo2.webp",
  ...
  },
  {
    ...
    img: "images/turandexihuan.webp",
    intro: "一部笑点十足的爱情轻喜剧。当2025年的情感主播进入到一本古早言情小说中，遇到了1999年的白切黑霸总，套路与反套路的终极对决，最终谁能胜出？为了回到熟悉的现实世界，情感主播林欢儿开启了一系列攻略霸总高海明的操作，却聪明反被聪明误，当她用尽全力通关，必须离开书中世界时，却发现自己早已深陷其中，不舍离开。从“欲走还留”到“欲留还走”，故事的最后，有情人能否终成眷属……",
    cats: [
      "奇幻",
      "爱情"
    ]
  ...
  },
  {
    ...
    img: "images/nianshaoyouwei.webp",
  ...
  },
  {
    ...
    img: "images/chongfanqingchun.webp",
  ...
  },
  {
    ...
    img: "images/chunzhenniandaideaiqing.webp",
  ...
  },
  {
    ...
    img: "images/jianghuyeyushiniandeng.webp",
  ...
  },
  {
    ...
    img: "images/meiguicongsheng.webp",
  ...
  },
  {
    ...
    img: "images/yinshendemingzi.webp",
  ...
  },
  {
    ...
    img: "images/binghuchongsheng.webp",
  ...
  },
  {
    ...
    img: "images/fangyuanbabaimi.webp",
  ...
  },
  {
    ...
    img: "images/jiaoutiancheng.webp",
    intro: "战鬼人陆千乔为了摆脱诅咒，借“贪官陆槐”的身份，与想要破除克夫命格的人族修仙者辛湄结成夫妻。这本是一场交易，各取所需，互利互惠。没想到正义感爆棚的新媳妇误以为他“受冤枉死”后，毅然杀上京城为夫报仇，引来了各大仙门追杀。已经“含怨惨死”的丈夫不得不亲自出手收拾局面。两人共同携手经历了一系列的惊险事件。陆千乔不仅完成了个人诉求，也揭开了普通人族与仙门之间的明争暗斗，两人剥丝抽茧，顺着线索一层层追查上去，最终发现了幕后操纵的黑手，于是两人并肩，化解了一场灭世危机。",
    cats: [
      "古装",
      "奇幻"
    ]
  },
  {
    ...
    img: "images/aiqingmeiyoushenhua.webp",
  ...
  },
  {
    ...
    img: "images/datangmiwudiyiji.webp",
  ...
  },
  {
    ...
    img: "images/aiqingyouyanhuo.webp",
  ...
  },
  {
    ...
    img: "images/jingchengqitan.webp",
  ...
  },
  {
    ...
    img: "images/zheyimiaoguohuo.webp",
  ...
  },
  {
    ...
    img: "images/bingzifengzhonglai.webp",
  ...
  },
  {
    ...
    img: "images/wugeshizongdeshaonian.webp",
  ...
  },
  {
    ...
    img: "images/shibingrongyao.webp",
  ...
  },
  {
    ...
    type: "悬疑科幻",
    cast: "主演待定",
    img: "images/kaiqi.webp",
    intro: "《开启》是电视剧《开端》的第二部，由正午阳光出品、侯鸿亮担任制片人、祈祷君编剧，延续时间循环的科幻悬疑题材，围绕“能否在全新的‘明天’一同醒来”展开悬念设定，计划于腾讯视频独家播出。",
    cats: []
  },
  {
    name: "人间清醒",
    ...
    img: "images/renjianqingxing.webp",
  ...
  },
  {
    ...
    img: "images/xiongyoumeigong.webp",
  ...
  },
  {
    ...
    img: "images/fengkuangdeheiyu.webp",
  ...
  },
  {
    ...
    img: "images/changfengqi.webp",
    file: "plans/changfengqi.pdf",
    fileLabel: "腾讯视频民国江湖悬疑大剧《长风起》招商方案",
  ...
  },
  {
    ...
    type: "荒诞喜剧",
    cast: "赵本山、王小利、葛珊珊等",
    img: "images/zoumashangren.webp",
    intro: "民国时期，兽医贾归田（赵本山 饰）因疏忽大意医坏了奉天驻军团长马德兵（王小利 饰）。为保性命，贾归田急中生智，说服与马德兵长相一模一样的外甥王老五（王小利 饰）冒充马德兵，到伏虎县上任县长。被迫上位的“山寨”县长面对盘根错节的各方势力状况不断，引发一系列啼笑皆非的荒诞故事。",
    cats: [
      "喜剧"
    ]
  },
  ...
  },
  {
    ...
    img: "images/longgufenxiang.webp",
  ...
  },
  {
    ...
    img: "images/wanguzuiqiangzong.webp",
  ...
  },
  {
    ...
    img: "images/cikedeshenghuo.webp",
  ...
  },
  {
    ...
    img: "images/daiwoxinglaishi.webp",
  ...
  },
  {
    ...
    img: "images/meiguizhanzheng.webp",
  ...
  },
  {
    ...
    img: "images/qianlijiangshantu.webp",
    intro: "1933年腊月十五，准备在上海开的一场中共地下党员的秘密会议还未开始，12名与会者就已有一半被抓，党员们认识到他们的秘密行动走漏了风声，内部可能存在叛徒。共产党员陈千里（张若昀 饰）临危受命，来到上海，他要从那12人中找出叛变者，肃清队伍，并在敌人的步步紧逼下完成另一项绝密任务。陈千里从过往的人和事中抽丝剥茧，拨开迷雾，以坚定的信仰保卫党的秘密转移行动——“千里江山图”按计划实施。",
    cats: [
      "民国",
      "历史"
    ]
  },
  {
    ...
    type: "近现代女性传奇",
    cast: "杨紫、欧豪",
    img: "images/yulanhuakaijunzailai.webp",
    intro: "小阿媛为救父，被卖到堂子里做了清倌人，后来身份几经转变。她是东渡日本的留学生，是表面风光的都督夫人，是毅然出走的“娜拉”，是独自将四个女儿培养成才的伟大母亲。她是以非凡勇气挣脱命运枷锁，长袖善舞上海滩，周旋各种势力之间，在时代浪潮中逆流而上，书写锦江饭店商业传奇的董竹君。",
    cats: [
      "传奇",
      "年代"
    ]
  },
  {
    ...
    type: "年代传奇",
    cast: "宋佳、高伟光、任彬、张瑶",
    img: "images/fangmingsanjiu.webp",
    intro: "烟火人间三十载，笑看风云三九来。讲述了草根女性陈三九从花炮小贩到商界强者的跌宕人生。以一簇烟火映照时代变迁，用一个小人物的三十年书写奋斗华章。",
    cats: [
      "传奇",
      "年代"
    ]
  },
  {
    ...
    type: "警匪刑侦",
    cast: "白敬亭、孙千、蓝盈莹",
    img: "images/xingjingshike1fenghuazhengmao.webp",
    intro: "该剧以九十年代，我国公安刑警破获多起社会影响恶劣的重案为背景，讲述了公安刑警在刑事侦查、刑侦技术、法医等多方面的突破和创新。歌颂公安干警在严厉打击刑事犯罪的过程中，挥洒青春热血，不断思考警察职业的意义、不断探索追求正义与真相的壮志情怀。",
    cats: [
      "刑侦"
    ]
  },
  {
    ...
    type: "古装传奇",
    cast: "龚俊、王玉雯",
    img: "images/baiyigongqing.webp",
    intro: "新朝初立，朝堂之上看似风平浪静，实则暗藏汹涌波涛。一夜之间，叶昭全家惨遭屠戮，唯他一人侥幸逃生。为探寻真相、报血海深仇，叶昭孤注一掷，冒名顶替，以孟剑卿的假身份潜入锦衣卫——王朝权力的核心之地，欲借朝廷之力手刃仇敌。 自此，他深陷凶险棋局。权臣在幕后翻云覆雨，江湖势力如乱麻般纠缠，各方杀机如影随形，步步紧逼。少年身处刀光剑影之中，性命如海上扁舟，却也屡得奇缘。他结识了肝胆相照的兄弟，愿以命相护；又得良师益友倾囊相助、信任托举，助他在残酷斗争中百炼成钢。少年以血肉为刃，完成复仇大业，斩破家仇血幕，于帝国至暗之中劈开曙光，朝着海疆破晓之处毅然前行。",
    cats: [
      "古装",
      "传奇"
    ]
  },
  {
    ...
    type: "古装爱情",
    cast: "包上恩、王弘毅",
    img: "images/yuemingqianli.webp",
    intro: "落难公主被迫和亲，流落异域，生死之际为以身侍神的禁欲君王所救。命运的齿轮就此运转，沙海圆月下的一瞥，竟是此生挚爱。共平山河，乱世情长，月明千里，吾道不孤。",
    cats: [
      "古装",
      "爱情"
    ]
