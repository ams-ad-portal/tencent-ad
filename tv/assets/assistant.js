...
(function () {
  ...
  /* 访客留言板（腾讯文档收集表：访客只能提交，看不到也删不了别人的；管理员在收集表「数据」页看全部） */
  const FEEDBACK_URL = "https://docs.qq.com/form/page/DZk5Yb3drZGxLWWJB#/fill";
  ...
  function buildFAQ() {
    ...
    {
      k: ["留言", "反馈", "提意见", "建议", "联系管理员", "找管理员", "我要留言", "提需求", "纠错"],
      a: "点这里给管理员留言：<br><a href=\"" + FEEDBACK_URL + "\" target=\"_blank\" rel=\"noopener\"><b>✍️ 打开留言板</b></a><br><br>打开后填「留言内容」提交即可。提交内容只有管理员能看到，其他访客看不到也改不了。"
    },
    {
...
function helpText() {
    if (TL) {
      const S = SITE;
      const isTV = S === "电视剧";
      const nameEx = isTV ? "尚公主" : "势均力敌的我们2";
      const castEx = isTV ? "孟子义参演了什么" : "白鹿参演了什么";
      return "你好 👋 我是站内小助手，可以帮你查" + S + "信息，试着这样问我（<b>直接点就能问</b>）：<br>"
        + "· " + askBtn(nameEx) + "（直接问名字看详情）<br>"
        + "· " + askBtn("26年Q4有哪些" + S) + "<br>"
        + "· " + askBtn("超级S+的" + S + "有哪些") + "<br>"
        + "· " + askBtn("爱情类的有哪些") + " / " + askBtn("悬疑类有哪些") + "<br>"
        + "· " + askBtn(castEx) + "（按嘉宾/主演查）<br>"
        + "· " + askBtn("哪些有方案") + " / " + askBtn("最近上线的是什么") + "<br>"
        + "· " + askBtn("我要留言") + "（给管理员提需求/纠错）";
    }
    return "你好 👋 我是站内小助手，可以帮你查刊例信息，试着这样问我（<b>直接点就能问</b>）：<br>"
      + "· " + askBtn("腾讯视频有哪些刊例") + "<br>"
      + "· " + askBtn("微信广告的报价") + " / " + askBtn("TME 有什么") + "<br>"
      + "· " + askBtn("一共有多少份刊例") + "<br>"
      + "· " + askBtn("最新季度的刊例") + "<br>"
      + "· " + askBtn("怎么下载") + " / " + askBtn("怎么在线查看") + " / " + askBtn("访问码怎么拿") + "<br>"
      + "· " + askBtn("我要留言") + "（给管理员提需求/纠错）";
  }
  ...
  function buildQuicks() {
    return TL
      ? ["能问什么？", "最新上线的是什么", "S+的有哪些", "怎么下载方案", "我要留言"]
      : ["能问什么？", "一共有多少份刊例", "腾讯视频有哪些", "怎么下载", "我要留言"];
  }
