...
(function () {
  ...
  /* 访客留言板（腾讯文档在线表格，访客打开后在表格末尾直接填写，管理员在表格里看全部留言） */
  const FEEDBACK_URL = "https://docs.qq.com/sheet/DZkNOb3NYcFVMeXVT";
  ...
  function buildFAQ() {
    return [
      ...
      },
      {
        ...
        a: "每个投放形式右侧有「📄 介绍文档」按钮：打开后右上角可直接下载；PDF 会在网页内预览，其他格式若不支持在线预览，可点右上角「下载」后本地查看。文档暂未补充的会显示灰态「文档待补充」。"
      },
      {
      ...
      },
      {
        ...
        a: "点这里给管理员留言：<br><a href=\"" + FEEDBACK_URL + "\" target=\"_blank\" rel=\"noopener\"><b>✍️ 打开留言表</b></a><br><br>打开后在表格末尾空行直接填「留言内容」即可（提交时间、来自站点、称呼选填）。管理员会在同一个表格里看到所有人的留言。"
      },
      {
  ...
  function buildQuicks() {
    return ["能问什么？", "一共有多少个形式", "朋友圈有哪些形式", "怎么看 Demo 视频", "我要留言"];
  }
