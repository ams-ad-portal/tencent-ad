...
(function () {
  ...
  /* 访客留言板（腾讯问卷，免登录填写；管理员在 wj.qq.com 后台看答卷） */
  const FEEDBACK_URL = "https://wj.qq.com/s2/27768344/niap/";
  ...
  function buildFAQ() {
    return [
      ...
      },
      {
        ...
        a: "点这里给管理员留言（腾讯问卷，免登录填写）：<br><a href=\"" + FEEDBACK_URL + "\" target=\"_blank\" rel=\"noopener\"><b>✍️ 打开留言板</b></a><br><br>内容纠错、想要新资料、功能建议都可以写在这里，管理员会在问卷后台看到。"
      },
      {
